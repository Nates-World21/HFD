...
module.exports = () => {
  ...
  if (__dirname.toLowerCase().replace(/\\/g, '/').includes('/windows/system32')) {
    ...
    console.log('HFD detected that you are trying to install HFD in the System32 folder.');
    console.log('This shouldn\'t be done as it will prevent HFD from functioning as expected.', '\n');
  ...
  if (!require('fs/promises')) {
    console.log(BasicMessages.INJECT_FAILED, '\n');
    console.log('HFD detected you\'re running an outdated version of NodeJS.');
    console.log('You must have at least NodeJS 10 installed for HFD to function.', '\n');
