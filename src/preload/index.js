...
require('../ipc/renderer.js');

console.log('[HFD] Loading HFD');
...
if (process.contextIsolated) {
  ...
  function fetchRealElement (element) {
    element.dataset.hfdReactInstancePointer = ++pointer;
    const realNode = webFrame.top.context.document.querySelector(`[data-hfd-react-instance-pointer="${pointer}"]`);
    realNode.removeAttribute('data-hfd-react-instance-pointer');
    return realNode;
  }
